...
def show_interface(sw):
    ...
    #Print the header
    print "%s %s %s" % ( '{:<14}'.format('Interface') , '{:<10}'.format('Speed'), 'description' )
    ...
    for each in data:
        ...
        print "%s %s %s" % ( '{:<14}'.format( data_result['interface_name'] ) , '{:<10}'.format( interface_speed ) , interface_description )
